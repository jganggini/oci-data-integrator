  ...
  | MODULE        : DBMS_CLOUD                                                                                    |
  | DESCRIPTION   : Credenciales para conectarnos a un Bucket en OCI desde Autonomous Database                    |
  |---------------------------------------------------------------------------------------------------------------|
  |    .----------------------.      .----------------------.      .----------------------.                       |
  ...
  |------------|--------------|------------------------------------------------------------|----------------------|
  | STAGING    | STG          | oracleidentitycloudservice/joel.ganggini@oracle.com        | .dr>3GRjr<dB6bc#x7(7 |
  |------------|--------------|------------------------------------------------------------|----------------------|
  | DATASET    | DTS          | oracleidentitycloudservice/joel.ganggini@oracle.com        | .dr>3GRjr<dB6bc#x7(7 |
  `--------------------------------------------------------------------------------------------------------------*/
...
DECLARE
    ...
    par_password            VARCHAR2(100)   := '.dr>3GRjr<dB6bc#x7(7';
