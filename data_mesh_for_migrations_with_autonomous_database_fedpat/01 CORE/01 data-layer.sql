...
BEGIN
    ...
    ELSIF (par_data_layer = 'WORKFLOW') THEN
        var_query := 'GRANT CREATE SESSION, ALTER SESSION, CREATE VIEW, CREATE PROCEDURE, SELECT ANY TABLE, INSERT ANY TABLE, UPDATE ANY TABLE, UNLIMITED TABLESPACE TO '||par_schema_name;
